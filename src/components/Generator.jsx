        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 py-3 px-4 border rounded-lg duration-200 hover:border-blue-600 " +
                (type === poison ? "border-blue-600 " : "border-transparent")
              }
              key={typeIndex}
            >
        ...
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          return (
            <button
              ...
              className={
                "bg-slate-950 py-2 px-2 border rounded-lg duration-200 hover:border-blue-600 " +
                (scheme === goals ? "border-blue-600 " : "border-transparent")
              }
              key={schemeIndex}
            >
